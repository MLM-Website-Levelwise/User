...
const menuItems: MenuItem[] = [
  {
    ...
    submenu: [
      ...
      { title: "Membership Card", icon: Download, path: "/dashboard/membershipcard" },
    ],
  },
  {
    title: "Shopping",
  ...
  },
  {
    ...
    submenu: [
      ...
      { title: "KYC Upload", icon: Upload, path: "/settings/kyc" 
        // isActive: true 
      },
    ],
  },
  {
    ...
    icon: Pin,
    submenu: [
      { title: "View Active PIN", icon: Eye, path: "/pin/active" },
      { title: "View Used PIN", icon: History, path: "/pin/used" },
    ],
  },
  {
    title: "Member",
    ...
    submenu: [
      ...
      { title: "Member List", icon: List, 
        // isActive: true
        path: "/member/mass-list" },
      { title: "Direct Member List", icon: UsersIcon, path: "/member/direct-list" },
      { title: "Tree View", icon: TreePine, path: "/member/tree" },
    ],
  },
  {
    title: "Purchase",
...
export function AppSidebar() {
  ...
  const [expandedItems, setExpandedItems] = useState<string[]>(["Dashboard", "Settings", "PIN", "Mass Influencer"]);
    ...
    <Sidebar className="bg-primary text-white border-r-0">
      <SidebarHeader className="border-b border-white/20 p-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-lg font-bold text-white">Prime Networks Inc</span>
        </div>
      </SidebarHeader>

      <SidebarContent className="px-4 overflow-visible">
        <SidebarGroup>
          <SidebarGroupLabel className="text-yellow-400 font-semibold mb-4">General</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
              {menuItems.map(item => (
                    ...
                    >
                      <div className="flex items-center justify-between w-full">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          {item.submenu === true && <span className="text-white/60">›</span>}
                        </div>
                      </div>
                    </SidebarMenuButton>
                  )}
