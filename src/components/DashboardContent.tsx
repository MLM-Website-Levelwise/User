    ...
    <div className="space-y-6 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <CardDescription>Follow our telegram group for next update</CardDescription>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-gradient-to-br from-purple-600 to-purple-800 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Sponsor Count</CardTitle>
        ...
        <Card className="bg-gradient-to-br from-purple-600 to-purple-800 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Downline Count</CardTitle>
            <MoreHorizontal className="w-4 h-4" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">2</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Investment (Self)</CardTitle>
            <MoreHorizontal className="w-4 h-4" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">1250.00</div>
            <div className="flex items-center space-x-2 mt-2">
              <span className="text-sm text-green-600">Rs. 1250.00</span>
              <span className="text-xs text-gray-500">Investment (Self)</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-600 to-purple-800 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Left Business</CardTitle>
            <MoreHorizontal className="w-4 h-4" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">1250</div>
            <div className="flex items-center space-x-2 mt-2">
              <span className="text-sm bg-purple-500 px-2 py-1 rounded text-xs">Rs. 1250</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-gradient-to-br from-purple-600 to-purple-800 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Right Business</CardTitle>
            <MoreHorizontal className="w-4 h-4" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">1250</div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Investment (Team)</CardTitle>
            <MoreHorizontal className="w-4 h-4" />
          </CardHeader>
          <CardContent>
            ...
            <div className="flex items-center space-x-2 mt-2">
              ...
              <span className="text-xs text-gray-500">Investment (Team)</span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-purple-600 to-purple-800 text-white">
          ...
          <CardContent>
            ...
            <div className="flex items-center space-x-2 mt-2">
              <span className="text-sm bg-red-500 px-2 py-1 rounded text-xs">0.00</span>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center space-x-2 mt-2">
              ...
              <span className="text-xs text-gray-500">Working Balance</span>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-br from-purple-600 to-purple-800 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Prev Working</CardTitle>
            <MoreHorizontal className="w-4 h-4" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">0.00</div>
